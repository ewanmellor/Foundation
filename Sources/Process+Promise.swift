...
extension Process {
     ...
     */
    public func launch(_: PMKNamespacer, qos: DispatchQoS = .default) -> Promise<(out: Pipe, err: Pipe)> {
        ...
        return DispatchQueue.global(qos: qos.qosClass).promise {
            self.waitUntilExit()
